...
interface ExecutiveMasterFiltersPanelProps {
  schema: ExecutiveMasterFilterSchema | undefined;
  isLoading?: boolean;
...
function fieldActiveCount(
  field: ExecutiveMasterFilterField,
  columnFilters: Record<string, string[]>,
  textFilters: Record<string, string>,
  dateFilters: Record<string, ExecutiveMasterDateFilter>
) {
...
function DateDropdown({
  ...
  field: ExecutiveMasterFilterField;
  value: ExecutiveMasterDateFilter;
  onChange: (range: ExecutiveMasterDateFilter) => void;
}) {
...
/** Horizontal filter chips for the Executive Master Sheet filter popup. */
export function ExecutiveMasterFiltersPanel({
  schema,
  isLoading,
  columnFilters,
  textFilters,
  ...
  onDateChange,
  onClearAll,
}: ExecutiveMasterFiltersPanelProps) {
