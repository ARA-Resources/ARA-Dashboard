...
import { normalizeCellValue, toHeaderKey } from "@/services/excel/cell-value";
...
/**
 * Detect the most likely header row when a hint is not provided.
 */
...
/**
 * Parse a worksheet into header + row records.
 * Column names always come from the file (never hardcoded).
 */
